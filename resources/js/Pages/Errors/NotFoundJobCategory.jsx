...
export default function NotFoundJobCategory () {
                    ...
                    <div className="d-flex gap-3">
                        ...
                        <div className="col-lg-6">
                            <div className="twm-error-content">
                                ...
                                <p>Тази категория не съществува!</p>
                                <Link href="/dashboard/admin/roles" className="site-button">
                                    Към всички категория
                                </Link>
                            </div>
                        </div>
                    </div>
...
NotFoundJobCategory.layout = page => <DashboardLayout children={page} />;
