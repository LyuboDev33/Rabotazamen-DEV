...
export default function NoMiddlewareAccess () {
                    ...
                    <div className="d-flex gap-3">
                        ...
                        <div className="col-lg-6">
                            <div className="twm-error-content">
                                ...
                                <p>Нямате права за да достъпите тези страници!</p>
                                <Link href="/dashboard" className="site-button">
                                    Отидете към Таблото
                                </Link>
                            </div>
                        </div>
...
NoMiddlewareAccess.layout = page => <DashboardLayout children={page} />;
